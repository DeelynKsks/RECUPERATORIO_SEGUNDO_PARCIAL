...
app.listen(3000, () => {
  console.log(`El servidor se está ejecutando en http://localhost:${process.env.DOCKER_SERVER_PORT_EXPOSED}`);
  console.log(`Endpoint de verificación para la conexión con MongoDB: http://localhost:${process.env.DOCKER_SERVER_PORT_EXPOSED}/mongodb`);
  console.log(`Endpoint de verificación para la conexión con MySQL: http://localhost:${process.env.DOCKER_SERVER_PORT_EXPOSED}/mysql`);
  console.log(`Endpoint de verificación para la conexión con MariaDB: http://localhost:${process.env.DOCKER_SERVER_PORT_EXPOSED}/mariadb`);
});
